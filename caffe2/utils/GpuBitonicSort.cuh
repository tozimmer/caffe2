...
__device__ inline void bitonicSort(K* keys,
  ...
  static_assert(math::integerIsPowerOf2(std::integral_constant<int, Power2SortSize>::value),
                "sort size must be power of 2");
  static_assert(math::integerIsPowerOf2(std::integral_constant<int, ThreadsPerBlock>::value),
